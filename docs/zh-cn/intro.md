...
|     | 开源版                                                                                                                                                                               | 创客版                                       | 教育版                                                                         | 专业版                                       |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- | --------------------------------------------------------------------------- | ----------------------------------------- |
| 芯片  | ESP32-S3 Xtensa©双核 240 MHz                                                                                                                                                        | ESP32-S3 Xtensa© 双核 240 MHz               | ESP32-S3 Xtensa© 双核 240 MHz                                                 | 待定                                        |
| 储存  | 8MB flash <br /> 8MB PSRAM                                                                                                                                                        | 16MB flash <br /> 8MB PSRAM               | 16MB flash <br /> 8MB PSRAM                                                 | 待定                                        |
| 屏幕  | 2.0寸 320×240 高清彩屏                                                                                                                                                                 | 2.0寸 320×240 高清彩屏                         | 2.0寸 320×240 高清彩屏                                                           | 待定                                        |
...
| 按钮  | 可编程按钮 × 9                                                                                                                                                                         | 超薄摇杆 × 1 <br /> 可编程按钮 × 5                 | 超薄摇杆 × 1 <br /> 可编程按钮 × 5                                                   | 可扩展摇杆 × 1 <br /> 可编程按钮 × 9                |
| 麦克风 | 无                                                                                                                                                                                 | MEMS 麦克风 × 1                              | MEMS 麦克风 × 1                                                                | MEMS 麦克风 × 1                              |
| 声音  | 扬声器 × 1                                                                                                                                                                           | 扬声器 × 1                                   | 无                                                                           | 扬声器 × 待定                                  |
| 接口  | Type-C USB × 1                                                                                                                                                                    | Type-C USB × 1 <br /> 多功能扩展口 × 1 <br />   | Type-C USB × 1 <br /> 多功能扩展口 × 1 <br /> 2.5mm 耳机口 × 1 <br /> 教育专用外接传感器 × 若干 | Type-C USB × 1 <br /> 多功能扩展口 × 1          |
| 尺寸  | 100mm × 38mm                                                                                                                                                                      | 100mm × 38mm                              | 100mm × 38mm                                                                | 待定                                        |
| 链接  | [立创开源硬件平台](https://oshwhub.com/blockcodelab/arcade_lite) <br /> [GitHub](https://github.com/BlockCodeLab/arcade-lite)  <br /> [Gitee](https://gitee.com/blockcodelab/arcade-lite) | 淘宝                                        | 联系客服                                                                        | 待定                                        |
