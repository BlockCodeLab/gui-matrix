...
| 电池  | 无                                                                                                                                                                                 | 800mAh 3.7v 锂电池                                                                | 待定                                        |
| 按钮  | 可编程按钮 × 9                                                                                                                                                                         | 四向摇杆 × 1 <br /> 可编程按钮 × 5                                                      | 可扩展摇杆 × 1 <br /> 可编程按钮 × 9                |
| 麦克风 | 无                                                                                                                                                                                 | MEMS 麦克风 × 1                                                                   | MEMS 麦克风 × 1                              |
| 声音  | 扬声器 × 1                                                                                                                                                                           | 无                                                                              | 扬声器 × 1                                   |
| 接口  | Type-C USB × 1                                                                                                                                                                    | Type-C USB × 1 <br /> 2.5mm 耳机口 × 1 <br /> 多功能扩展口 × 1 <br /> （教育版）教育专用传感器 × 若干 | Type-C USB × 1 <br /> 多功能扩展口 × 1          |
| 尺寸  | 100mm × 38mm                                                                                                                                                                      | 100mm × 38mm                                                                   | 待定                                        |
| 链接  | [立创开源硬件平台](https://oshwhub.com/blockcodelab/arcade_lite) <br /> [GitHub](https://github.com/BlockCodeLab/arcade-lite)  <br /> [Gitee](https://gitee.com/blockcodelab/arcade-lite) | （创客版）淘宝 <br /> （教育版）联系客服                                                       | 待定                                        |
