const sb3BlocksToArcadeBlocks = {
  ...
  // lego wedo 2.0
  wedo2_motorOnFor: ['wedo2', 'motorOnSec'],
  ...
  wedo2_menu_MOTOR_ID: ['wedo2', 'menu_MOTOR_ID'],
  wedo2_menu_MOTOR_DIRECTION: ['wedo2', 'menu_MOTOR_DIRECTION'],
  wedo2_setLightHue: ['wedo2', 'setLightHue'],
  wedo2_whenDistance: ['wedo2', 'whenDistance'],
  wedo2_menu_OP: ['wedo2', 'menu_OP'],
  ...
  wedo2_menu_TILT_DIRECTION: ['wedo2', 'menu_TILT_DIRECTION'],
  wedo2_menu_TILT_DIRECTION_ANY: ['wedo2', 'menu_TILT_DIRECTION_ANY'],
